...
enum class HighlightLinePosition {
    ...
    /**
     * The lines will correspond to the position of the highlight content (popups). For example,
    ...
    /**
     * Horizontal oriented line, independent of highlight content orientation
     */
    HORIZONTAL,

    /**
     * Vertical oriented line, independent of highlight content orientation
     */
    VERTICAL,
